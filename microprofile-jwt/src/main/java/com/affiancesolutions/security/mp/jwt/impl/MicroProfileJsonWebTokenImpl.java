package com.affiancesolutions.security.mp.jwt.impl;
...
public class MicroProfileJsonWebTokenImpl implements JsonWebToken {
    ...
    private static String jwtIssuer = ConfigProvider.getConfig().getValue("mp.jwt.verify.issuer", String.class);

    private static String jwtAudience = ConfigProvider.getConfig().getValue("mp.jwt.verify.audiences", String.class);
