...
COPY --chown=1001:0  build/jacoco/jacocoagent.jar /liberty/usr/shared/config/lib/

# Add application WAR
COPY --chown=1001:0  build/libs/KingTiger-KTBTracker-API-1.0.0.war /config/apps/
